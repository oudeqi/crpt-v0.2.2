    ...
    methods: {
      numberFormat: function numberFormat(number) {
        ...
        if (number.includes(dot)) {
          var _number$split = number.split(dot),
              _number$split2 = slicedToArray(_number$split, 2),
              a = _number$split2[0],
              b = _number$split2[1];
      ...
      retialAmount: function retialAmount() {
        var _this = this;
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 4:
                  res = _context2.sent;
                  _this2.principalTn = _this2.numberFormat(res.data);
      ...
      handleOpenDetailFrame: function handleOpenDetailFrame() {// Router.openPage({key: 'hxd_r_try_detail'})
        // api.openFrame({
        //   name: "hxd_r_try_frm",
