...
var PageController = /*#__PURE__*/function (_Service) {
  ...
  function PageController(props) {
    ...
    _this.profile = {
      ...
      pickers: {
        ...
        maturityYear: Array.from({
          length: 50
        }, function (v, k) {
          var year = String(k + new Date().getFullYear());
          return {
            name: year,
            id: year
          };
  ...
  createClass(PageController, [{
    ...
    value: function bindEvents() {
      ...
      this.bindSubmitEvents(); // this.bindDateEvents()
    }
  }, {
    key: "initFormStatus",
    value: function () {
      var _initFormStatus = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var gtId, gtCreditId, guaranteeRes, _guaranteeRes$data, houseFillStatus, carFillStatus, socialFillStatus;
      ...
      function initFormStatus() {
        return _initFormStatus.apply(this, arguments);
      }
    ...
    key: "initData",
    value: function () {
      var _initData = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(_ref) {
              ...
              case 15:
                try {
                  ...
                  if (operateRes.data.maturityYear) {
                    ...
                    dom = document.querySelector('#maturityYearBox');

                    if (operateRes.data.farmsNature === 2) {
                      dom.classList.remove('hidden');
                      document.querySelector('#maturityYear').innerHTML = "".concat(operateRes.data.maturityYear, " \u5E74");
                    }
                  } // key: 养殖品种
      ...
      Utils$1.UI.setPicker({
        success: function success(selected) {
          ...
          if (name === 'farmType') {
            ...
            dom.innerHTML = "".concat(value.name, " \u5E74");
          }
        },
        ...
        parant.onclick = function (e) {
          ...
          if (ev.target.nodeName === 'SPAN') {
            ...
            if (item === 'livestockType') {
              var _dom2 = document.querySelector('#maturityYearBox');
    ...
    key: "submitFormData",
    value: function () {
      var _submitFormData = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
    ...
    value: function validate(formData) {
      var farmsCategory = formData.farmsCategory;
      var rules = {
        landNature: {
          type: 'regexp',
          rule: /\w+/g,
