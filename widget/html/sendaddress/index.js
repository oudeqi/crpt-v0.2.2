...
var Service = /*#__PURE__*/function () {
  ...
  createClass(Service, [{
    key: "querySendAddress",
    // 担保业务申请-文书送达地址查询
    value: function querySendAddress(gtCreditId) {
    ...
    value: function saveApply(params) {
      return http.post('/crpt-guarantee/guarantor/document/address/insert', {
        body: params
      });
    }
  }]);
...
var PageController = /*#__PURE__*/function (_Service) {
  ...
  createClass(PageController, [{
    ...
    value: function _renderBaseDocument(data) {
      ...
      $api.byId('address').value = "".concat(data.addrProvince, "/").concat(data.addrCity, "/").concat(data.addrCounty);
      ...
      $api.byId('peiouAddress').value = "".concat(data.spAddrProvince, "/").concat(data.spAddrCity, "/").concat(data.spAddrCounty);
    ...
    value: function _initValidation() {
      var cfg = {
        ...
        gtCounterList: {
          ...
          get: function get() {
            var data = [];
            var list = $api.domAll($api.byId('list'), '.item');
