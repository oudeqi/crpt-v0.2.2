...
var service = {
  getQuota: function getQuota() {
    return http$1.get("/crpt-credit/credit/credit/amount");
  },
  getQuotaList: function getQuotaList() {
    return http$1.get("/crpt-credit/credit/credit/mine/productList");
  }
};
...
apiready = function apiready() {
  ...
  var page = new Vue({
    ...
    methods: {
      handleRenderCharts: function handleRenderCharts(_ref) {
        var t = _ref.t,
            y = _ref.y;
      ...
      handleGetPageData: function handleGetPageData() {
        var _this = this;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  ...
                  if (res.code === 200) {
                    data = res.data;
                    _this.availablAmount = numeral(data.availablAmount).format('0,0');
                    _this.limitAmount = numeral(data.limitAmount).format('0,0');
                    _this.loanAmount = numeral(data.loanAmount).format('0,0');
                    t = numeral(data.limitAmount).subtract(data.loanAmount).value();
                    y = data.loanAmount;

                    _this.handleRenderCharts({
                      t: t,
                      y: y
                    });
                  }
      ...
      handleGetQuotaList: function handleGetQuotaList() {
        var _this2 = this;
      ...
      handleToContactUs: function handleToContactUs() {
        Router$2.openPage({
          key: 'contactus'
        });
      }
    ...
    mounted: function mounted() {
      ...
      Utils$1.UI.setRefreshHeaderInfo({
        success: function success() {
          _this3.handleGetPageData();

          _this3.handleGetQuotaList();
