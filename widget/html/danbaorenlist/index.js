  ...
  createClass(pageController, [{
    ...
    value: function _renderList(key, arr) {
      ...
      var collapseBodyTpl = arr.map(function (item, index) {
        ...
        return "\n        <li class=\"collapse-item\">\n          <label class=\"checkbox\">\n            <input type=\"checkbox\" data-id=\"".concat(item.gtCounterId, "\" data-phone=\"").concat(item.phone || '', "\" checkbox-trigger=\"body\">\n            <span></span>\n          </label>\n          <div class=\"cont\" click-trigger=\"item\" data-id=\"").concat(item.gtCounterId, "\" data-type=\"").concat(key, "\">\n            <span class=\"txt\">\u62C5\u4FDD\u4EBA").concat(index + 1, "</span>\n            <span class=\"tag ").concat(statusMap[item.status] && statusMap[item.status][1], "\">").concat(statusMap[item.status] && statusMap[item.status][0], "</span>\n          </div>\n        </li>\n      ");
      });
    ...
    value: function () {
      var _save = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        var _this$initData, gtCreditId, gtId, postData, res;
