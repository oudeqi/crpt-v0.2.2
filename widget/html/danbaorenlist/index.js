...
var Service = /*#__PURE__*/function () {
  ...
  createClass(Service, [{
    key: "queryList",
    // 担保列表查询
    value: function queryList(params) {
    ...
    key: "sendDanbaoren",
    value: function sendDanbaoren(params) {
    ...
    key: "saveDanbaoren",
    value: function saveDanbaoren(params) {
...
var pageController = /*#__PURE__*/function (_Service) {
  ...
  createClass(pageController, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return this.queryList(this.initData);
    ...
    value: function bindEvent() {
      ...
      document.querySelector('body').addEventListener('click', function (e) {
        var headerCheckbox = $api.closest(event.target, '[checkbox-trigger="header"]');

        if (headerCheckbox) {
          var collapse = $api.closest(event.target, '.collapse');
          var bodyCheckbox = $api.domAll(collapse, '[checkbox-trigger="body"]');

          for (var _i2 = 0, _Object$keys2 = Object.keys(bodyCheckbox); _i2 < _Object$keys2.length; _i2++) {
      ...
      $api.byId('allChecked').onclick = function (e) {
        var bottomCheckbox = event.target;
        var allBodyCheckbox = $api.domAll(document.querySelector('body'), '[checkbox-trigger="body"]');

        for (var _i3 = 0, _Object$keys3 = Object.keys(allBodyCheckbox); _i3 < _Object$keys3.length; _i3++) {
        ...
        var allHeaderCheckbox = $api.domAll(document.querySelector('body'), '[checkbox-trigger="header"]');

        for (var _i4 = 0, _Object$keys4 = Object.keys(allHeaderCheckbox); _i4 < _Object$keys4.length; _i4++) {
      ...
      document.querySelector('body').addEventListener('click', function (e) {
        ...
        if ($api.attr(event.target, 'click-trigger') === 'del') {
          ...
          // 去下一页
          var _item = $api.closest(event.target, '[click-trigger="item"]');
    ...
    value: function () {
      var _save = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        var allTag, allSigned, _this$initData, gtCreditId, gtId, postData, res;

        return regenerator.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                allTag = Array.from(document.querySelectorAll('.tag'));
                allSigned = allTag.every(function (item) {
                  return item.dataset.status === 5 || item.dataset.status === '5';
                });
              ...
              case 5:
                ...
                _context2.prev = 6;
                _this$initData = this.initData, gtCreditId = _this$initData.gtCreditId, gtId = _this$initData.gtId;
                postData = {
                  gtCreditId: gtCreditId,
                  gtId: gtId
                };
                _context2.next = 11;
                return this.saveDanbaoren(postData);
    ...
    key: "send",
    value: function () {
      var _send = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
        var _this3 = this;

        var body, checked, postData, res;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                body = document.querySelector('body');
                checked = Array.from($api.domAll(body, 'input[checkbox-trigger="body"]:checked'));
              ...
              case 6:
                ...
                checked.forEach(function (item) {
                  postData.push({
                    ...
                    gtCreditId: _this3.initData.gtCreditId,
                    gtId: _this3.initData.gtId
                  });
                });
                api.showProgress({
                  title: '加载中...',
                ...
                _context3.prev = 9;
                _context3.next = 12;
                return this.sendDanbaoren(postData);
