...
var routerConfig = (_routerConfig = {
  // 消息中心
  msgcenter: {
...
}, defineProperty(_routerConfig, "face", {
  name: 'face',
  title: '活体识别调试',
  url: 'widget://html/face/index.html',
  bgColor: '#fff',
  reload: true,
  navigationBar: navigationBarWhite
}), defineProperty(_routerConfig, "login_index", {
  name: 'login_index',
  url: 'widget://html/login_index/index.html',
  bgColor: '#fff',
  reload: true,
  slidBackEnabled: false
}), defineProperty(_routerConfig, "account_login", {
  name: 'account_login',
...
var profile = _objectSpread$1({}, routerConfig, {}, routerHXDConfig, {}, routerMap);
