...
var service = {
  postQueryEBSOrders: function postQueryEBSOrders(params) {
    return http$1.post("/crpt-order/order/hxd/query/warehouse/order/list", {
      body: params
    });
  },
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 4;
                  return service.postQueryEBSOrders({
