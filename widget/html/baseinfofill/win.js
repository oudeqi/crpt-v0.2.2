...
var profile = _objectSpread$1({}, routerConfig$1, {}, routerConfig, {}, routerHXDConfig, {}, routerMap);
...
var Router$1 = /*#__PURE__*/function () {
  ...
  createClass(Router, [{
    ...
    value: function openPage(_ref) {
      var key = _ref.key,
          params = _ref.params;
      api.openTabLayout(_objectSpread$2({}, profile[key], {}, params));
    }
  }]);
...
var isIdCardNo = function isIdCardNo(no) {
  var no15 = /^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$/.test(no);
  var no18 = /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X|x)$/.test(no);
  return no15 || no18;
};
  ...
  return new Vue({
    ...
    data: function data() {
      return {
        ...
        marriageMap: {},
        // {"10":"未婚","20":"已婚","21":"初婚","22":"再婚","23":"复婚","30":"丧偶","40":"离婚","90":"未说明的婚姻状况"}
        educationMap: {},
        // 学历 {"10":"研究生","20":"大学本科","30":"大学专科或专科学校","40":"中等专业学校或中等技术学校","50":"技术学校","60":"高中","70":"初中","80":"小学","90":"文盲或半文盲","99":"未知"}
        academicDegreeMap: {},
        // 学位 {"0":"其他","1":"名誉博士","2":"博士","3":"硕士","4":"学士","9":"未知"}
        livingConditionsMap: {},
        ...
        postData: {
          ...
          // 是否为农户  1：是   0：否
          relationship: '',
          // 注：20 已婚 21 初婚 22 再婚 23 复婚 这四种情况亲属关系直接为配偶，不让用户选择
          relationName: '',
          // 姓名
          relationPhone: '',
          // 手机号
    ...
    methods: {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return filterDict('custMarriage');

                case 3:
                  _this.marriageMap = _context.sent;
                  _context.next = 6;
                  return filterDict('custEducation');

                case 6:
                  _this.educationMap = _context.sent;
                  _context.next = 9;
                  return filterDict('custAcademicDegree');

                case 9:
                  _this.academicDegreeMap = _context.sent;
                  _context.next = 12;
                  return filterDict('livingConditions');

                case 12:
                  _this.livingConditionsMap = _context.sent;
                  _context.next = 15;
                  return filterDict('custIsPeasant');

                case 15:
                  _this.isPeasantMap = _context.sent;
                  _context.next = 18;
                  return filterDict('relationship');

                case 18:
                  _this.relationshipMap = _context.sent;
                  api.hideProgress();
      ...
      handleMarriageClick: function handleMarriageClick() {
        var _this2 = this;

        var marriageKeys = Object.keys(this.marriageMap);
        var marriageValues = Object.values(this.marriageMap);
        ActionSheet('请选择婚姻状况', marriageValues, function (index) {
          _this2.postData.marriage = marriageKeys[index];
          $api.dom($api.byId('marriage'), 'input').value = marriageValues[index];
        });
      },
      handleChildrenClick: function handleChildrenClick() {
        var _this3 = this;

        var btns = ['无子女', '有子女'];
        ActionSheet('请选择子女状况', btns, function (index) {
          $api.dom($api.byId('isChildren'), 'input').value = btns[index];
          _this3.postData.isChildren = String(index);
        });
      },
      handleEducationClick: function handleEducationClick() {
        var _this4 = this;

        var educationKeys = Object.keys(this.educationMap);
        var educationValues = Object.values(this.educationMap);
        ActionSheet('请选择学历情况', educationValues, function (index) {
          $api.dom($api.byId('education'), 'input').value = educationValues[index];
          _this4.postData.education = educationValues[index];
          _this4.postData.educationCode = educationKeys[index];
        });
      },
      handleAcademicDegreeClick: function handleAcademicDegreeClick() {
        var _this5 = this;

        var academicDegreeKeys = Object.keys(this.academicDegreeMap);
        var academicDegreeValues = Object.values(this.academicDegreeMap);
        ActionSheet('请选择学位情况', academicDegreeValues, function (index) {
          $api.dom($api.byId('academicDegree'), 'input').value = academicDegreeValues[index];
          _this5.postData.academicDegree = academicDegreeValues[index];
          _this5.postData.academicDegreeCode = academicDegreeKeys[index];
        });
      },
      handlePermanentAddressClick: function handlePermanentAddressClick() {
        var _this6 = this;
        ...
        CitySelector(function (selected) {
          ...
          _this6.postData.permanentAddress = addr;
        });
      },
      handleIsPeasantClick: function handleIsPeasantClick() {
        var _this7 = this;

        var isPeasantKeys = Object.keys(this.isPeasantMap);
        var isPeasantValues = Object.values(this.isPeasantMap);
        ActionSheet('是否为农户', isPeasantValues, function (index) {
          _this7.postData.isPeasant = isPeasantKeys[index];
          $api.dom($api.byId('isPeasant'), 'input').value = isPeasantValues[index];
        });
      },
      handleAddressClick: function handleAddressClick() {
        var _this8 = this;
        ...
        CitySelector(function (selected) {
          ...
          _this8.postData.addrProvince = a.name;
          _this8.postData.addrProvinceCode = a.id;
          _this8.postData.addrCity = b.name;
          _this8.postData.addrCityCode = b.id;
          _this8.postData.addrCounty = c.name;
          _this8.postData.addrCountyCode = c.id;
        });
      },
      handleLivingConditionsClick: function handleLivingConditionsClick() {
        var _this9 = this;

        var livingConditionsKeys = Object.keys(this.livingConditionsMap);
        var livingConditionsValues = Object.values(this.livingConditionsMap);
        ActionSheet('请选择居住状况', livingConditionsValues, function (index) {
          _this9.postData.livingConditions = livingConditionsKeys[index];
      ...
      handleRelationshipClick: function handleRelationshipClick() {
        ...
        var relationshipKeys = Object.keys(this.relationshipMap);
        var relationshipValues = Object.values(this.relationshipMap);
        ActionSheet('请选择亲属关系', relationshipValues, function (index) {
          _this10.postData.relationship = relationshipKeys[index];
          $api.dom($api.byId('relationship'), 'input').value = relationshipValues[index];
        });
      },
      __formValidation: function __formValidation() {
      ...
      submit: function submit() {
        ...
        if (Object.keys(this.marriageMap).length === 0) {
          return;
        }

        if (Object.keys(this.educationMap).length === 0) {
          return;
        }

        if (Object.keys(this.academicDegreeMap).length === 0) {
          return;
        }

        if (Object.keys(this.livingConditionsMap).length === 0) {
          return;
        }

        if (Object.keys(this.isPeasantMap).length === 0) {
          return;
        }

        if (Object.keys(this.relationshipMap).length === 0) {
          return;
        }
        ...
        this.loading = true;
        var postData = this.postData;
        this.service.submit(this.url, postData).then(function (res) {
          api.hideProgress();
