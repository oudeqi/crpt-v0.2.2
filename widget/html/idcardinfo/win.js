...
var Service = /*#__PURE__*/function () {
  ...
  createClass(Service, null, [{
    ...
    value: function getContract() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 3;
...
apiready = function apiready() {
      ...
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 6:
              tyeeNode = getProtocolFromNode(node, userinfo.userType); // protocolType 1-个人，2-企业，3-通用
  ...
  document.querySelector('#next').onclick = function () {
    if (submitStatus === 'notsubmit') {
      ...
      http$1.upload('/crpt-cust/saas/realnameauth', {
        values: {
          name: _name,
          gender: gender,
          number: number,
