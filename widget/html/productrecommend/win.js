...
var profile = _objectSpread$4(_objectSpread$4(_objectSpread$4({}, routerHXDConfig), routerMap), routerConfig);
...
var Router$1 = /*#__PURE__*/function () {
  ...
  createClass(Router, [{
    ...
    value: function openPage(_ref) {
      var key = _ref.key,
          params = _ref.params;
      api.openTabLayout(_objectSpread$5(_objectSpread$5({}, profile[key]), params));
    }
  }]);
...
var Service = /*#__PURE__*/function () {
  ...
  createClass(Service, null, [{
    ...
    value: function queryDanbaoStatus() {
      return http$1.get('/crpt-guarantee/gt/apply/query');
    }
  }]);
  ...
  return new Vue({
    ...
    methods: {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 2:
                  ...
                  _context2.prev = 3;
                  _context2.next = 6;
                  return Service.getData(_this2.userType);
      ...
      handleBtnClick: function handleBtnClick(record) {
        ...
        var type = record.type + ''; // 产品类型：1-信用贷款（押金贷） 2-担保贷款 3-上游入库单贷款（好销宝）
      ...
      // 去担保开通页面
      __goDanbao: function __goDanbao(id, name) {
        Service.queryDanbaoStatus().then(function (res) {
          api.toast({
            msg: '已有开通的担保产品',
            location: 'middle'
          });
      ...
      handleItemClick: function handleItemClick(record) {
        openProductDetails({
          id: record.id,
          open: 0 // 1 已开通， 0未开通
