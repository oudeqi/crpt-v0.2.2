...
var Service = /*#__PURE__*/function () {
  ...
  createClass(Service, null, [{
    key: "licenseUpload",
    value: function licenseUpload(file) {
      return http$1.upload('/crpt-cust/cust/personal/business/license/upload', {
        files: {
          personalCertNoFile: file
        }
      }, {
        headers: {},
        timeout: 10000
...
Vue.directive('decimal-keeps', {
  bind: function bind(el, binding) {
    var decimalKeeps = binding.value;
...
function vmInit() {
  return new Vue({
    ...
    computed: {
      ...
      loanPayeeAccountNo: function loanPayeeAccountNo() {
        // 贷款收款账号
        return this.pageParam.loanPayeeAccountNo;
      },
      loanPayeeAccountName: function loanPayeeAccountName() {
        // 贷款收款账户名称
      ...
      surplusReceivableBond: function surplusReceivableBond() {
        // 剩余应收保证金
        return parseFloat(this.pageParam.surplusReceivableBond || 0);
      },
      availableValue: function availableValue() {
        // 实际可用额度
        var surplusReceivableBond = this.surplusReceivableBond;
        var maxAvailable = this.maxAvailable;
    ...
    methods: {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 1;
                  _context.next = 4;
                  return Service.licenseUpload(file);
      ...
      submit: function submit() {
        ...
        if (parseFloat(this.applyMoney) < this.minAvailable) {
          api.toast({
            msg: "\u7533\u8BF7\u91D1\u989D\u4E0D\u80FD\u5C0F\u4E8E\u6700\u4F4E\u53EF\u8D37\u91D1\u989D\uFF0C".concat(this.minAvailable, "\u5143"),
            location: 'middle'
          });
          return;
        }
        ...
        var createLoanOrderArgus = {
          id: this.id,
          // 代养合同id
          productId: this.productId,
          // 产品id
          maxLoanAmount: this.availableValue,
          // 最高可贷金额
          applyAmount: this.applyMoney,
          // 申请金额
          interestRate: this.productDetails.interestRate,
          // 贷款利率
          loanTerm: this.productDetails.loanTerm,
          // 贷款期限（单位：月
          loanDueDate: this.productDetails.loanDueDate,
          // 贷款到期日
          repayType: this.productDetails.repayType,
          // 还款方式（标记：4-到期还本付息；5-等额本息；7-先息后本）
          custName: this.name,
          // 借款人姓名
          loanPayeeAccountNo: this.loanPayeeAccountNo,
          // 贷款收款账号
          loanPayeeAccountName: this.loanPayeeAccountName,
          // 贷款收款账户名称
          personalCertNo: this.companyCode,
          // 个人社会信用代码
          enterpriseWorkers: this.workerCount,
          // 从业人数
