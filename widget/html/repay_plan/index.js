...
apiready = function apiready() {
  ...
  function getPageData(cb) {
    ...
    loading = true;
    http.get("/crpt-credit/credit/repay/query/repayplan?pageSize=".concat(pageSize, "&pageNo=").concat(pageNo, "&orderNo=").concat(orderNo)).then(function (res) {
      loading = false;
