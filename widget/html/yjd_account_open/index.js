...
var Service = /*#__PURE__*/function () {
  ...
  createClass(Service, null, [{
    key: "sendCode",
    value: function sendCode(cardNo, phone) {
      return http$1.post('/crpt-cust/customer/account/code/get', {
        body: {
          cardNo: cardNo,
          phone: phone
        }
    ...
    key: "bankCardOcr",
    value: function bankCardOcr(file) {
      return http$1.upload('/crpt-biz/biz/ocr/bankcard', {
        files: {
          file: file
        }
      }, {
    ...
    key: "openAccount",
    value: function openAccount(_ref) {
      var cardName = _ref.cardName,
          cardNo = _ref.cardNo,
          phone = _ref.phone,
          verifyCode = _ref.verifyCode,
          uniqueCode = _ref.uniqueCode;
      return http$1.post('/crpt-cust/customer/open/account/affirm', {
        body: {
          cardName: cardName,
          cardNo: cardNo,
          phone: phone,
