...
var Service$1 = /*#__PURE__*/function () {
  function Service() {
    classCallCheck(this, Service);
  }
...
var PageController = /*#__PURE__*/function (_Service) {
  ...
  function PageController(props) {
    ...
    _this = _super.call(this); //  统一管理数据model data

    _this.data = {
      flowStatus: 0,
      // 0	无填写, 1 担保业务申请填写, 2 反担保人列表,3 文书送达地址, 4	其他附件上传
      gtId: '' // 担保申请id
  ...
  createClass(PageController, [{
    ...
    key: "initUIModal",
    value: function initUIModal() {
      var self = this;
      Array.from(document.querySelectorAll('.cl-cell_text')).forEach(function (dom, i) {
        var _index = parseInt(dom.getAttribute('data-index'));
