  ...
  createClass(Service, null, [{
    ...
    value: function auth(_ref) {
      var smsCode = _ref.smsCode,
          uniqueCode = _ref.uniqueCode,
          bankCardNo = _ref.bankCardNo,
          userId = _ref.userId;
      return http$1.post('/crpt-credit/credit/openloan/prebindcardconfirmphnm', {
        body: {
          smsCode: smsCode,
...
function vmInit() {
  return new Vue({
    ...
    computed: {
      bankCardNo: function bankCardNo() {
        // 银行卡卡号
        return this.pageParam.bankCardNo;
      },
      bankCardMobile: function bankCardMobile() {
        // 银行预留手机号
        return this.pageParam.bankCardMobile;
      },
      bankCardName: function bankCardName() {
        // 开户行名称
    ...
    methods: {
        ...
        return asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
          ...
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  if (!(_this.inputValue && _this.inputValue.length === 6)) {
                    _context.next = 21;
                    break;
                  }
                ...
                case 3:
                  ...
                  _this$preAuthData = _this.preAuthData, _this$preAuthData$uni = _this$preAuthData.uniqueCode, uniqueCode = _this$preAuthData$uni === void 0 ? '' : _this$preAuthData$uni, _this$preAuthData$ban = _this$preAuthData.bankCardNo, bankCardNo = _this$preAuthData$ban === void 0 ? '' : _this$preAuthData$ban, _this$preAuthData$use = _this$preAuthData.userId, userId = _this$preAuthData$use === void 0 ? '' : _this$preAuthData$use;
                  _context.prev = 6;
                  _context.next = 9;
                  return Service.auth({
                    uniqueCode: uniqueCode,
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 2:
                  _this2.code.loading = true;
                  _this2.code.txt = '验证码发送中...';
                  _context2.prev = 4;
                  _context2.next = 7;
                  return _this2.__sendCode();

                case 7:
                  _this2.__countDown();

                  _this2.$refs['hidden_ipt'].focus();
                ...
                case 11:
                  ...
                  _this2.preAuthData = {};
                  _this2.code.loading = false;
                  _this2.code.txt = '获取验证码';
                  api.toast({
      ...
      __sendCode: function __sendCode() {
        var _this3 = this;

        return asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
          var res, _res$data, uniqueCode, bankCardNo, userId;
