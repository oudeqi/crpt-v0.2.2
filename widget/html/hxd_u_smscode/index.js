        ...
        return asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
          ...
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  Utils$1.UI.showLoading('发送中...');
                  _context.prev = 1;
                  _context.next = 4;
                  return service.postAgainSendSMSCode({
                    phone: _this2.phone
                  });
        ...
        return asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  Utils$1.UI.showLoading('支用校验中');
                  _context2.prev = 1;
                  _context2.next = 4;
                  return service.postVerify({
                    phone: _this3.phone,
                    orderIds: _this3.orderIds,
                    verification: _this3.smscode.slice(0, 6)
                  });
